...
final class ItemListViewControllerTests: XCTestCase {
    ...
    func testItSendsTheNewItemCreationRequestMessageToItsDelegateWhenTheCreateNewItemKeyCommandIsInvoked() {
        givenAnItemListViewController()
        whenTheUserInvokesTheNewItemKeyCommand()
        XCTAssertTrue(mockDelegate.receivedNewItemCreationMessage)
    }
